        ...
        stage('Deploy catalogue-service') {
            ...
            steps {
                script {
                    ...
                    powershell(script: """
                        Start-Process -FilePath 'java' -ArgumentList '-jar', 'backend with eclipse\\catalogue-service\\target\\catalogue-service-0.0.1-SNAPSHOT.jar' -NoNewWindow -WindowStyle Hidden
                    """)
                }
            }
        }
